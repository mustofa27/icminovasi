            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select name="area_of_expertise" id="area_of_expertise" required
                        ...
                        <option value="informatics" {{ old('area_of_expertise') === 'informatics' ? 'selected' : '' }}>Informatics</option>
                        <option value="creative" {{ old('area_of_expertise') === 'creative' ? 'selected' : '' }}>Creative</option>
                        <option value="mechatronics" {{ old('area_of_expertise') === 'mechatronics' ? 'selected' : '' }}>Mechatronics</option>
                    </select>
